...
git clone https://devopseasylearning:glpat-XVx-F5ezYW38sdu1Xuz2@gitlab.com/session03/instructors/key-access-server.git 
...
git push  https://devopseasylearning:glpat-XVx-F5ezYW38sdu1Xuz2@gitlab.com/session03/instructors/key-access-server.git 
